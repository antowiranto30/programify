<section class="w-full pt-18 pb-20 bg-white">
    <div class="relative px-12 mx-auto max-w-7xl">

        <div class="relative grid items-center grid-cols-1 gap-10 p-12 overflow-hidden shadow-2xl md:p-16 lg:p-20 xl:p-24 bg-gradient-to-r from-purple-400 to-purple-500 rounded-2xl md:grid-cols-5 lg:gap-0">
            ...
            <div class="relative z-30 col-span-1 md:col-span-3">
                ...
                <p class="max-w-sm my-6 text-base font-normal text-purple-200 xl:max-w-lg lg:pr-0 pr-7 lg:text-xl">Are you ready to build the page of your dreams? You can use our expertly-crafted designs to you tell your story.</p>
                <a href="#" class="flex items-center justify-center w-full px-4 py-2 text-base font-medium leading-6 text-purple-500 whitespace-no-wrap bg-white border-2 border-transparent rounded-full shadow-sm md:w-auto md:inline-flex hover:bg-transparent hover:text-white hover:border-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600">
                    Get Started
                </a>
            </div>
            <div class="flex items-center h-full col-span-1 md:col-span-2">
                <img src="https://ouch-cdn2.icons8.com/mcElI4TNkH13fMRICaK44JyMZlF2M9fUpXHW6fYlZRY/rs:fit:912:912/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9zdmcvNDY2/LzViMmQ5NWFkLTg0/NTUtNGY2Mi04YjUw/LWQ2MGIwZmE2YzBl/Ni5zdmc.png" class="relative top-0 right-0 object-cover w-full -mr-1 rounded md:max-w-sm md:w-auto max-w-none lg:absolute lg:max-w-md xl:max-w-lg lg:mt-9" alt="Dashboard">
            </div>
        </div>
    </div>
</section>
